...
class qpsk-mod(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "qpsk-mod")
        ...
        self.connect((self.digital_constellation_modulator_0_0_0_0_0, 0), (self.qtgui_freq_sink_x_0, 3))
...
def main(top_block_cls=qpsk-mod, options=None):
